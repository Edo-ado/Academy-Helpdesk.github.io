...
export default function MaintainListTechnician() {
 ...
 const handleDetail = (Id) => {
    ...
    const handleDelete = (Id) => {
        ...
        console.log(`Eliminar técnico con ID: ${Id}`);
    };
...
<Table>
    ...
    <TableBody>
        {data.map((row) => (
            ...
            >
                <TableCell className="px-10">{row.Usercode}</TableCell>
                <TableCell className="px-10">{row.UserName}</TableCell>
                <TableCell className="px-10">{row.Email}</TableCell>
