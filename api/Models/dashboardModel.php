...
class dashboardModel
{
    ...
    public function TicketsPerMonth()
    {
        ...
        FROM Tickets 
        WHERE YEAR(Ticket_Start_Date) = YEAR(CURRENT_DATE())
...
ORDER BY 
    ...
    public function RankingTechByCump()
    {
        ...
        ROUND(
            ...
            NULLIF(SUM(CASE WHEN t.Ticket_End_Date IS NOT NULL THEN 1 ELSE 0 END), 0), 2) AS PorcentajeCumplimientoResolucion
        FROM 
        Users u
